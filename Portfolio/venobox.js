        ...
        venobox: function(options) {
          ...
          var options = $.extend(defaults, options);
            ...
            return this.each(function() {
				  ...
				  $(".vbox-overlay").addClass("vbox-overlay-new");
				  $(this).addClass("vbox-info-edit");
				  $(".vbox-video-content.active").addClass("visible");
				  $(".video_content").removeClass("hidden");
				  $(".vbox-close").addClass("hidden");
  				  $(".wraper-video-content").addClass("animated slideInRight show");
				
				 });
             /* --------close info for mobile-------- */
              $('.close-vinfo-bt').click(function(e){
				$('.vbox-info').removeClass("vbox-info-edit");
				  $(".vbox-overlay").removeClass("vbox-overlay-new");
				  $(".vbox-video-content.active").removeClass("visible");
				  $(".video_content").removeClass("hidden");
				  $(".vbox-close").removeClass("hidden");
  				  $(".wraper-video-content").removeClass("animated slideInRight show");
				});
				/* --------close -------- */                 
				 $('.vbox-close').click(function(e){
				  //$("#content").addClass("hidden");
				  $(".vbox-video-content").removeClass("active");
